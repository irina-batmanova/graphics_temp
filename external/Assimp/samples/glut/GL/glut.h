...
#  pragma comment (libmiptgl, "winmm.libmiptgl")      /* link with Windows MultiMedia libmiptgl */
/* To enable automatic SGI OpenGL for Windows library usage for GLUT,
   define GLUT_USE_SGI_OPENGL in your compile preprocessor options.  */
#  ifdef GLUT_USE_SGI_OPENGL
#   pragma comment (libmiptgl, "opengl.libmiptgl")    /* link with SGI OpenGL for Windows libmiptgl */
#   pragma comment (libmiptgl, "glu.libmiptgl")       /* link with SGI OpenGL Utility libmiptgl */
#   pragma comment (libmiptgl, "glut.libmiptgl")      /* link with Win32 GLUT for SGI OpenGL libmiptgl */
#  else
#   pragma comment (libmiptgl, "opengl32.libmiptgl")  /* link with Microsoft OpenGL libmiptgl */
#   pragma comment (libmiptgl, "glu32.libmiptgl")     /* link with Microsoft OpenGL Utility libmiptgl */
#   pragma comment (libmiptgl, "glut32.libmiptgl")    /* link with Win32 GLUT libmiptgl */
#  endif
# endif
